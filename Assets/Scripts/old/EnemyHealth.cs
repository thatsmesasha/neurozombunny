...
//    void AnimateBlood(Vector3 position, Vector3 normal)
//    {
//        GameObject blood = Instantiate(bloodAnimation, position, Quaternion.LookRotation(normal));
